...
import 'package:movies_app/features/movies/presentation/components/cast_card.dart';
import 'package:movies_app/features/movies/presentation/components/movie_card_details.dart';
import 'package:movies_app/features/movies/presentation/components/review_card.dart';
...
class MovieDetailsView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) =>
          locator<MovieDetailsBloc>()..add(GetMovieDetailsEvent(movieId)),
      child: Scaffold(
