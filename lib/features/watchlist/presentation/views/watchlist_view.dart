...
import 'package:movies_app/features/watchlist/presentation/components/empty_watchlist_text.dart';
...
class WatchlistView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => locator<WatchlistBloc>()..add(GetWatchListItemsEvent()),
      child: Scaffold(
