...
import 'package:movies_app/features/tv_shows/presentation/components/episode_card.dart';
import 'package:movies_app/features/tv_shows/presentation/components/seasons_section.dart';
import 'package:movies_app/features/tv_shows/presentation/components/tv_show_card_details.dart';
...
class TVShowDetailsView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) =>
          locator<TVShowDetailsBloc>()..add(GetTVShowDetailsEvent(tvShowId)),
      child: Scaffold(
